...
function simulateFlight() {
  ...
  setInterval(() => {
    t += 0.1;
    // Base coordinates (Bengaluru, Karnataka, India) with tiny jitter to keep UI live
    telemetry.lat        = 12.971600 + (Math.sin(t) * 0.000001);
    telemetry.lon        = 77.594600 + (Math.cos(t) * 0.000001);
